...
SO = platform.system()
if SO == "Darwin":
    PERSONAJE = "Alvert Einstein"; EMOJI_PERSONAJE = "🧑‍🔬"; VOZ = "Juan"
elif SO == "Windows":
    PERSONAJE = "Marie Curie"; EMOJI_PERSONAJE = "👩‍🔬"; VOZ = "Hortensia"
else:
    PERSONAJE = "Personaje"; EMOJI_PERSONAJE = "👨‍🔬🔬"; VOZ = None

EMOJI_USUARIO = "🧑‍💻"
OLLAMA_OPTIONS = {"num_ctx":4096, "num_predict": 512, "temperature": 0.7, "top_p": 0.9, "repear_pnalty": 1.1}
KEPP_ALIVE = True
    ...
    def burbuja(texto, es_usuario):
        return ft.Row(
            [
                ...
                ft.Container(
                    content=ft.Text(texto, color=ft.Colors.WHITE if es_usuario else ft.Colors.BLACK, size=16, selectable=True),
    ...
    page.add(
        ft.Container(
            content=ft.Column([
                ...
                mensajes, 
                ft.Row([
                    ft.ElevatedButton("🎤Provar voz", on_click=provar_voz, bgcolor=ft.Colors.GREEN_400, color=ft.Colors.WHITE),
